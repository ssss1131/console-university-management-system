...
public class ViewStudentsCommand implements Command {
    ...
    public void execute() {
        ...
        List<LessonRecord> lessonRecords = teacherService.getLessonRecords(teacher, semester, selectedDiscipline, selectedStudent);

        view.showStudentRecords(selectedStudent, lessonRecords);
    }
}
